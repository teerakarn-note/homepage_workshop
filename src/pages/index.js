...
function Index() {
    ...
    function showImage(item) {
        if (item.img !== undefined) {
            ...
            if (item.img == "") imgPath = "Noimage.jpg";
            return <img className="card-img-top" height='200px' src={imgPath} alt="" />
        }
        return <></>;
    }
    ...
    return <>
        ...
        <Mymodal id='modalCart' title='ตะกร้าสินค้าของฉัน'>
            ...
            <div className="text-center">
                จำนวน {sumQty} ชิ้น รวมเป็นเงิน {sumPrice.toLocaleString('th-TH')} บาท
            </div>
            <div className=" mt-3">
                <div className="alert alert-info">
                    โอนเงิน กรุงไทย xxxx-xxxx-xxx-1234 ธีระกานต์ หาสุข
                </div>
                <div className="mt-3">
                    <div>ชื่อผู้ซื้อ</div>
                ...
                <button className="btn btn-primary mt-3" onClick={handleSave}>
                    <i className="fa fa-check mr-2 "></i>ยืนยัน
                </button>
            </div>
        </Mymodal>
    </>
